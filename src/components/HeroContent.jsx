...
const HeroContent = () => {
  const handleDownload = () => {
    saveAs(
      "/public/cv/Vinnath Satharasinghe Full Stack Web Developer (2024).pdf",
      "Vinnath Satharasinghe.pdf"
    );
  };
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-full h-full flex justify-center items-center mt-[20px]"
      >
        <img
        ...
        <img
          ...
          alt="work icons"
          className="absolute max-w-[330px] h-auto mr-[80px] mt-[140px]"
        />
      </motion.div>
    </motion.div>
  );
